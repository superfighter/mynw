...
function displayFolderPath(folderPath) {
    document.querySelector('#current-folder').innerText = folderPath
}
...
function bindSearchField(cb) {
    document.querySelector('#search').addEventListener('keyup', cb, false);
}
...
function resetFilter() {
    const items = document.querySelectorAll('.item');
    Array.from(items).map(item => item.style = null)
}
module.exports = {
